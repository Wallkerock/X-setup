...
hi CursorLine term=bold cterm=bold guifg=LightGrey guibg=Grey40 ctermfg=NONE ctermbg=251
hi CursorLineNr term=bold cterm=bold guifg=#FFFFFF guibg=black ctermfg=255 ctermbg=131
...
" STATUS BAR COLORS
au InsertEnter * hi statusline guifg=White guibg=#FF0000 ctermfg=015 ctermbg=181
au InsertLeave * hi statusline guifg=White guibg=#EEE8D5 ctermfg=255 ctermbg=131
hi statusline guifg=black guibg=NONE ctermfg=255 ctermbg=131

hi User1 ctermfg=015 ctermbg=181 guibg=#4e4e4e guifg=#adadad
hi User2 ctermfg=008 ctermbg=181 guibg=#303030 guifg=#adadad
hi User3 ctermfg=231 ctermbg=181 guibg=#303030 guifg=#303030
hi User4 ctermfg=239 ctermbg=181 guibg=#4e4e4e guifg=#4e4e4e
