...
" LINE NUMBER
hi LineNr ctermbg=236 ctermfg=Grey

" CURSOR LINE
hi CursorLine term=bold cterm=bold ctermbg=236 guibg=Grey40 guifg=LightGrey
...
au InsertLeave * hi statusline guifg=black guibg=#8fbfdc ctermfg=black ctermbg=white
hi statusline guifg=black guibg=#8fbfdc ctermfg=black ctermbg=white
