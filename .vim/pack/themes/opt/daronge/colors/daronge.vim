...
" LINE NUMBER
hi LineNr ctermbg=233 ctermfg=Grey

" CURSOR LINE
hi CursorLine term=bold cterm=bold ctermbg=234 guibg=Grey40 guifg=LightGrey
hi CursorLineNr term=bold cterm=bold guifg=#050505 guibg=lightgrey ctermfg=51 ctermbg=237
