...
# program/process names and corresponding glyphs
guis = OrderedDict({
    'terminals': '',
    'browser': '#',
    'firefox': '',
...
# the resulting glyph used will be that of the corresponding key
combine_guis = {
    'terminals': ('urxvt', 'termite', 'xterm'),
    'firefox': ('firefox'),
    'filemanager': ('thunar', 'nautilus', 'ranger'),
    'remote-desktop': ('TeamViewer', ),
    'pdfviewer': ('evince', 'zathura'),
    'image': ('viewnior', 'qqiv', 'ristretto'),
    'player': ('smplayer', 'mpv', 'vlc'),
    'editor': ('sublime_text'),
}
